...
| 7 | What is the **jacuzzi studios'** (formerly "Jacuzzi Suite") weekly rate? *(still open — but see the note below: no weekly rate is published for any room type, so the answer is now On request, not Public)* | | | On request |
...
| Jacuzzi studios (formerly "Jacuzzi Suite") — how many | | | Internal |
...
**Studio Queen** *(named "Queen Suite" until 2026-09-16 — the owner renamed it: "they are not suites")*

| Rate type | Peak season | Off season | Minimum stay | Confidence |
|---|---|---|---|---|
| Nightly | **$95** — confirmed in writing by the owner 2026-09-09, and again 2026-09-16: "$95 a night for the Studio Queen" | | | GM Approved |
...
| Rate type | Peak season | Off season | Minimum stay | Confidence |
|---|---|---|---|---|
| Nightly | **$120** — changed from $108 on 2026-09-17, owner's instruction ("the Studio handicap king needs to be changed to $120 a night") | | | GM Approved |
| Weekly (7 nights) | *Not published — call for price* | *Not published — call for price* | | GM Approved |
| Monthly | | | | |
| Typical negotiated corporate | | | | |
...
| Rate type | Peak season | Off season | Minimum stay | Confidence |
|---|---|---|---|---|
| Nightly | **Studio Jacuzzi King: $149** — confirmed in writing by the owner 2026-09-17 ("confirm 149"), matching its labelled export. *Studio Jacuzzi Two Queen and Studio King (Kitchenette): no number.* | | | GM Approved (Studio Jacuzzi King) |
| Weekly (7 nights) | *Not published — call for price* | *Not published — call for price* | | GM Approved |
| Monthly | | | | |
| Typical negotiated corporate | | | | |

> **2026-09-17 — RATE CONFIRMED: $149.** The owner confirmed it in writing ("confirm 149"). It is now published everywhere the other rates are, and the labelled export is in the homepage gallery. The note below is the record of the day before.
>
...
**None of these four figures may be published again.** They are not stale versions of a current rate — they are retired. The current answer for a weekly stay is *Call for Price*, and the current nightly floor is $95 (the Studio Queen, since 2026-09-09).
...
1. **The nightly rates in §2.2 are confirmed** and are published: $95 Studio Queen (added 2026-09-09) / $108 Studio King / $120 Studio Two Queen / $120 Handicap / Accessible Studio King (was $108 until 2026-09-17) / $155 Pet-Friendly Studio Two Queen / $135 Pet-Friendly Room / $149 Studio Jacuzzi King (confirmed 2026-09-17).
...
| **Jacuzzi Suite** | **No — CGI renders only** *(superseded 2026-09-16: the owner photographed the **Studio Jacuzzi King**, first named Jacuzzi King Suite — `Jacuzzi-Studio/`, full coverage; the Studio Jacuzzi Two Queen is still unphotographed)* | `37/44/49/49a.webp` → `Jacuzzi-Studio/` | 11, page live, $149 (confirmed 2026-09-17) |
...
| ~~Photograph a **Jacuzzi Suite**~~ | **Done 2026-09-16** for the Studio Jacuzzi King (first named Jacuzzi King Suite); its page is live. Rate confirmed at $149 on 2026-09-17 (§2.2). Still needed: re-exports of the remaining labelled photos with "Studio" names and current prices, and photographs of the Studio Jacuzzi Two Queen if it is to have a page. |
